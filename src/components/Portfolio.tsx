    ...
    return <div className={styles.site}>
      ...
      <div className={styles.headerInner}>
        ...
        <div className={styles.headerRight}>
          <a href="/Uday_Kiran_Tella_Resume_____.pdf" target="_blank" rel="noreferrer" className={styles.headerResumeBtn} aria-label="Download Resume PDF">
            <Download size={14} />
            <span>Resume</span>
